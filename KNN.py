...
selector = KNN_featureselection(large, k=9) #define selector
...
with open('/rhome/ymu015/bigdata/cs205/forward_history_k9.txt', 'w') as f:
...
with open('/rhome/ymu015/bigdata/cs205/backward_history_k9.txt', 'w') as f:
